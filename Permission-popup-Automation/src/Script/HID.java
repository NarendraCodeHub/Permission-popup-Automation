...
public class HID {
	...
	public static void askdefault() throws InterruptedException {
		// Scenario 1: Reset or ask default HID permissions
        ChromeOptions Options = new ChromeOptions();
        
        HashMap<String, Object> Prefs = new HashMap<>();
        
        Prefs.put("profile.default_content_setting_values.WebHID", 0);
	...
	public static void allow() throws InterruptedException {
		// Scenario 2: Allow HID permissions
        ChromeOptions Options = new ChromeOptions();
        
        Options.addArguments("--enable-features=WebHID");

        generic_script(Options);
	}
	
	public static void block() throws InterruptedException  {
		// Scenario 3: Block HID permissions
        ChromeOptions Options = new ChromeOptions();
        
        Options.addArguments("--disable-features=WebHID");
	...
	public static void generic_script( ChromeOptions Options) throws InterruptedException {
        ...
        driver.findElement(By.id("hid")).click();
